...
Manages external system integrations (ISE, AD, IoT).
"""
import sys
...
from clarion.api.routes import connectors, certificates, ise_config
...
logger.info(f"Connector Service: Database initialized at {db_path}")

app = FastAPI(
    title="Clarion Connector Service",
